...
const TRANSLATIONS = {
  en: {
    ...
    // MBTI & Share
    mbti_share_prefix: "My investment type is",
  ...
  ko: {
    ...
    tagline: "나의 투자 MBTI는?",
    headline: "3분 투자 테스트<br>나의 투자 성격을 알아보자!",
    stat_time: "3분",
    ...
    mbti_share_prefix: "내 투자 유형은",
    mbti_share_suffix: "너의 투자 MBTI는? 3분이면 알 수 있어!",
    share_twitter: "트위터 / X",
    share_whatsapp: "WhatsApp",
    share_native: "공유하기",
  ...
  hi: {
    ...
    mbti_share_prefix: "मेरा निवेश प्रकार है",
