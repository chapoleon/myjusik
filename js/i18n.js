...
const TRANSLATIONS = {
  en: {
    ...
    share_instagram: "Instagram Story",
    ...
    pricing_desc: "Pro starts with a 7-day free trial, then $4.99/mo.",
    pricing_launch_badge: "Launch members: limited 500 — lifetime low price",
    pricing_launch_remaining_label: "Spots left",
    pricing_free_name: "Free",
    pricing_free_desc: "Test + Results + 3 ETF picks",
    pricing_free_price: "$0",
    pricing_pro_name: "Pro",
    pricing_pro_desc: "Daily alerts + Weekly report",
    pricing_pro_price: "$4.99/mo",
    pricing_pro_monthly_price: "$4.99/mo",
    pricing_pro_yearly_price: "$39.99/yr",
    pricing_pro_frame: "$0.16/day",
    pricing_pro_yearly_frame: "$0.11/day",
    pricing_premium_badge: "Premium",
    pricing_premium_name: "Premium",
    pricing_premium_desc: "AI portfolio check + real-time signals + VIP",
    pricing_premium_price: "$14.99/mo",
    pricing_monthly: "Monthly",
    pricing_yearly: "Yearly ($39.99)",
    pricing_btn_free: "Start",
    pricing_btn_pro_trial: "Start 7-day free trial",
    pricing_btn_premium: "Apply",
    pricing_trial_fineprint: "Auto-renews after 7 days. Cancel anytime.",
    pricing_item_test: "Personality test",
    pricing_item_result: "View results",
    pricing_item_etf: "3 ETF picks",
    pricing_item_daily: "Daily stock alerts",
    pricing_item_weekly: "Weekly report",
    pricing_item_ai_diagnosis: "AI portfolio diagnosis",
    pricing_item_realtime: "Real-time trade signals",
    pricing_item_vip: "Kakao VIP room",
    pricing_popular_badge: "Most popular",
    pricing_toast_pro_trial: "Pro trial started (monthly).",
    pricing_toast_pro_yearly: "Pro selected (yearly).",
    pricing_toast_premium: "Premium request received.",
    questions: [
      {
  ...
  ko: {
    meta_description: "나의 투자 성향을 파악하고, 지금 나에게 맞는 ETF를 찾아보세요",
    page_title: "MoneyFit - 나와 맞는 투자 찾기",
    tagline: "그래서 뭘 사야 되는데?",
    headline: "나의 투자 성향을 파악하고,<br>지금 나에게 맞는 ETF를 찾아보세요",
    stat_time: "3분",
    ...
    premium_deep_report_price: "4,900원",
    premium_deep_report_subprice: "하루 163원 ☕",
    ...
    premium_rebalancing_price: "14,900원",
    premium_rebalancing_badge: "Pro",
    ...
    // Pricing
    pricing_title: "가격",
    pricing_desc: "프로는 7일 무료 체험 후 월 4,900원입니다.",
    pricing_launch_badge: "런칭 멤버 500명 한정 — 평생 ₩4,900 고정",
    pricing_launch_remaining_label: "남은 자리",
    pricing_free_name: "무료",
    pricing_free_desc: "성향 테스트 + 결과 + ETF 3개 추천",
    pricing_free_price: "₩0",
    pricing_pro_name: "프로",
    pricing_pro_desc: "매일 종목 알림 + 주간 리포트",
    pricing_pro_price: "월 ₩4,900",
    pricing_pro_monthly_price: "월 ₩4,900",
    pricing_pro_yearly_price: "연 ₩39,900",
    pricing_pro_frame: "하루 163원 ☕",
    pricing_pro_yearly_frame: "월 ₩3,325 (32% 할인)",
    pricing_premium_badge: "프리미엄",
    pricing_premium_name: "프리미엄",
    pricing_premium_desc: "AI 포트폴리오 진단 + 실시간 신호 + VIP방",
    pricing_premium_price: "월 ₩14,900",
    pricing_monthly: "월간",
    pricing_yearly: "연간 (₩39,900)",
    pricing_btn_free: "시작하기",
    pricing_btn_pro_trial: "7일 무료 체험 시작",
    pricing_btn_premium: "신청하기",
    pricing_trial_fineprint: "7일 후 자동 결제(₩4,900). 언제든 취소 가능.",
    pricing_item_test: "성향 테스트",
    pricing_item_result: "결과 확인",
    pricing_item_etf: "ETF 3개 추천",
    pricing_item_daily: "매일 종목 알림",
    pricing_item_weekly: "주간 리포트",
    pricing_item_ai_diagnosis: "AI 포트폴리오 진단",
    pricing_item_realtime: "실시간 매매 신호",
    pricing_item_vip: "카카오 VIP방",
    pricing_popular_badge: "가장 인기🔥",
    pricing_toast_pro_trial: "프로 7일 무료 체험이 시작되었습니다.",
    pricing_toast_pro_yearly: "프로(연간) 선택 완료!",
    pricing_toast_premium: "프리미엄 신청이 접수되었습니다.",
    questions: [
      {
        title: "나이대가 어떻게 되세요?",
