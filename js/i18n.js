...
const TRANSLATIONS = {
  en: {
    ...
    tagline: "Find the right investment for you",
    headline: "Precision investment profile<br>in just 10 questions!",
    stat_time: "3 min",
  ...
  ko: {
    meta_description: "10가지 질문으로 나와 맞는 투자를 찾아드립니다",
    page_title: "MoneyFit - 나와 맞는 투자 찾기",
    tagline: "나와 맞는 투자를 찾아드려요",
    headline: "10가지 질문으로<br>투자 성향을 정밀 분석!",
    stat_time: "3분",
  ...
  ja: {
    ...
    tagline: "あなたに合った投資を見つけます",
    headline: "10の質問で<br>投資性格を精密分析！",
    stat_time: "3分",
  ...
  hi: {
    ...
    tagline: "आपके लिए सही निवेश खोजें",
    headline: "10 सवालों में<br>निवेश प्रोफ़ाइल का सटीक विश्लेषण!",
    stat_time: "3 मिनट",
    stat_time_label: "समय",
